...
export class Bounce extends Plugin {
  ...
  protected calcUnderflowX(): number {
    ...
    const x1 = typeof box.x === "undefined" ? 0 : box.x * this.parent.scale.x;
    ...
    switch (this.underflowX) {
      case -1:
        ...
        break;
      case 1:
        x = this.parent.screenWidth - this.parent.screenWorldWidth - x1;
        break;
      default:
        x = (this.parent.screenWidth - this.parent.screenWorldWidth) / 2 - x1;
    }
    // UPDATES END
  ...
  protected calcUnderflowY(): number {
    ...
    // UPDATES START
    const box = this.options.bounceBox;
    const y1 = typeof box.y === "undefined" ? 0 : box.y * this.parent.scale.y;
    ...
    switch (this.underflowY) {
      case -1:
        ...
        break;
      case 1:
        y = this.parent.screenHeight - this.parent.screenWorldHeight - y1;
        break;
      default:
        y = (this.parent.screenHeight - this.parent.screenWorldHeight) / 2 - y1;
    }
    // UPDATES END
  ...
  private oob(): Record<"left" | "right" | "top" | "bottom", boolean> &
    ...
    if (box) {
      ...
      return {
        ...
        right: this.parent.right > x1 + width,
        top: this.parent.top < y1,
        bottom: this.parent.bottom > y1 + height,
        topLeft: new Point(x1 * this.parent.scale.x, y1 * this.parent.scale.y),
        bottomRight: new Point(
          (x1 + width) * this.parent.scale.x - this.parent.screenWidth,
          (y1 + height) * this.parent.scale.y - this.parent.screenHeight
        )
      };
      // UPDATES END
    }
